...
import com.pzhuedu.along.baidu.adapter.MassFragmentAdapter;
...
public class MassFragment extends Fragment {
    ...
    private MassTransitRouteResult result;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        result = (MassTransitRouteResult) getArguments().get("result");
        rvFragmentTransit.setLayoutManager(new LinearLayoutManager(container.getContext()));
        rvFragmentTransit.setAdapter(new MassFragmentAdapter(container.getContext(),result.getRouteLines()));
