...
public class DrivingRouteOverlay extends OverlayManager {
    ...
    boolean focus = false;
    public static List<Overlay> myOverlayList = new ArrayList<>();
    /**
     * 构造函数
     * 
     * @param baiduMap
    ...
    public final List<OverlayOptions> getOverlayOptions() {
        ...
        if (mRouteLine.getAllStep() != null
                && mRouteLine.getAllStep().size() > 0 && isSameCity) {
...
//            }
            ...
            PolylineOptions option = new PolylineOptions().points(points).textureIndex(traffics)
                    .width(20).dottedLine(isDotLine).focus(true)
                        .color(getLineColor() != 0 ? getLineColor() : Color.argb(178, 177, 169, 128)).zIndex(0);
            if (isDotLine) {
